...
func (bs *Server) SubmitProposerSlashing(
	...
	return &ethpb.SubmitSlashingResponse{
		SlashedIndices: []types.ValidatorIndex{req.Header1.Header.ProposerIndex},
	}, nil
}
...
func (bs *Server) SubmitAttesterSlashing(
	...
	indices := sliceutil.IntersectionUint64(req.Attestation1.AttestingIndices, req.Attestation2.AttestingIndices)
