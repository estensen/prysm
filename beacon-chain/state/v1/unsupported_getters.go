...
func (b *BeaconState) CurrentEpochParticipation() ([]byte, error) {
	return nil, errors.New("function CurrentEpochParticipation is not supported for phase 0 beacon state")
}
...
func (b *BeaconState) PreviousEpochParticipation() ([]byte, error) {
	return nil, errors.New("function PreviousEpochParticipation is not supported for phase 0 beacon state")
}

// InactivityScores is not supported for phase 0 beacon state.
func (b *BeaconState) InactivityScores() ([]uint64, error) {
	return nil, errors.New("function InactivityScores is not supported for phase 0 beacon state")
}
...
func (b *BeaconState) CurrentSyncCommittee() (*ethpb.SyncCommittee, error) {
	return nil, errors.New("function CurrentSyncCommittee is not supported for phase 0 beacon state")
}
...
func (b *BeaconState) NextSyncCommittee() (*ethpb.SyncCommittee, error) {
	return nil, errors.New("function NextSyncCommittee is not supported for phase 0 beacon state")
}
